...
export const MENU_ITEMS: MenuItem[] = [
  // Speciality Coffees
  {
    ...
    options: ["Whole Milk (Standard)", "Oat Milk (+40 ETB)", "Almond Milk (+40 ETB)", "Soy Milk (+40 ETB)"]
  },
  {
    id: "rose-latte",
  ...
  // Signature Dishes
  {
    ...
    options: ["Standard", "Gluten-Free Bread (+80 ETB)", "No Ricotta (Vegan Option)"]
  },
  {
    id: "avocado-feta",
    ...
    options: ["Poached (Standard)", "Fried Egg", "No Egg (-50 ETB)"]
  },
  {
    id: "brioche-french",
  ...
  },
  {
    ...
    options: ["Sesame Bagel", "Everything Bagel", "Gluten-Free Bagel (+80 ETB)"]
  },
  ...
  },
  {
    ...
    options: ["Vanilla Bean Ice Cream", "Double Scoop (+60 ETB)", "No Ice cream"]
  }
];
